...
// 🔴 EXECUTION THRESHOLD
const MIN_TELEGRAM_STRENGTH = 2.5;
...
// RUN ENGINE
// ========================================
export async function runBTCmod1(symbol = SYMBOL) {
  ...
  // 🔴 HARD TELEGRAM FILTER (THIS IS THE KEY CHANGE)
  if (permission !== "TRADE" || zone.strength < MIN_TELEGRAM_STRENGTH) {
    console.log(`[CTWL-Pro] Skipped Telegram — strength=${zone.strength.toFixed(2)}, permission=${permission}`);
    return;
  }
