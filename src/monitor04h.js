...
const PAIRS_FILE = "./pairs4h.txt";

// 40% invalidation
const INVALIDATION_RATIO = 0.30;
...
async function fetchDailyOpen(symbol) {
  ...
  const url =
    `${BINANCE}?symbol=${symbol}&interval=4h&limit=1`;
...
let currentBlock = getCurrent4HBlock();



setInterval(async () => {

  const block = getCurrent4HBlock();
  ...
  console.log("");
  console.log("=================================");
  console.log("NEW 4H CANDLE");
  console.log("Refreshing Levels...");
  console.log("=================================");
  console.log("");

  // Keep the rest of your refresh code exactly the same.
